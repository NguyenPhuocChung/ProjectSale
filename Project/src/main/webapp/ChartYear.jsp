<%-- 
    Document: ChartYear
    Created on: Nov 1, 2023, 3:26:13 PM
    Author: nguye
--%>
...
<html>
    ...
    <head>
        ...
        <script type="text/javascript">
            ...
            function drawChart() {
                var dataAvailable = ${not empty data1};
                if (dataAvailable) {
                    var data2 = google.visualization.arrayToDataTable([
                        ['Year', 'Total Price'],
            <c:forEach items="${data1}" var="entry">
    ...
    <a href="/AddminController/AllYear" class="btn btn-danger" style="color: white; text-decoration: none; margin: 10px 0 0 10px;">All Year</a>
