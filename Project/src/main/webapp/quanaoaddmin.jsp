<%-- 
    Document   : quanaoaddmin
    Created on : Oct 19, 2023, 3:00:59 PM
    Author     : nguye
--%>
...
<html>
            ...
            <div class="container menu1" style="margin-top: 0; padding-bottom: 0;">
                ...
                <div class="collapse navbar-collapse" id="navbarNav">
                    <ul class="navbar-nav">
                        ...
                        <li class="nav-item">
                            <a class="nav-link" href="/AddminController/Statistics/History">History Buy</a>                        </li>
    ...
    <body>
        <main class="container">
            <h2 style="text-align: center; color: chocolate;">List all Clothes</h2>
            <div class="btnheader">
                    ...
                    <tbody>
                        <%
                            ...
                            try {
                                ...
                                ResultSet rs = cdao.getQuanAo(cate);
                                while (rs.next()) {
                        %>
                        <tr>
